...
namespace ArticlesCrawler.Crawler.Service
{
    ...
    {   
        ...
        private readonly ILogger<VNExpressCrawler> _logger;
        private string strUrl;

        public const string ConstSource = "vnexpress";

        public VNExpressCrawler(IArticleService articleService, IConfiguration configuration, ILogger<VNExpressCrawler> logger)
        {
